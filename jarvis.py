...
import requests
from facelock import faceLocksyatem
from functions import greet_user, speak, take_user_input
...
from os_ops import open_calculator, open_camera, open_cmd, open_notepad, open_discord, screenShot
...
if __name__ == '__main__':
    name=faceLocksyatem()
    print(name)
    speak(f"Hi {name} good to see you again ")
    greet_user(name)
    while True:
